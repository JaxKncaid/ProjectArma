...
*/
	player createDiaryRecord["changelog",
		[
			"Change Log 3.2.0",
				"
					The official 3.2.0 Change Log Can Be Found Here: http://www.arma-life.com/forums/index.php?/forum/16-change-logs/
				"
		]
	];
	
	player createDiaryRecord["log",
		[
			"New Mission File And Functions",
				"
					Check http://www.arma-life.com/forums/index.php?/forum/16-change-logs/ For The Full Change Log
				"
		]
	];
		...
		[
			"Serverrules", 
				"
				These are considered rule breaks and will get you banned<br/><br/>
				...
				3. Homophobic Or Racist Remarks<br/>
				4. Sexual Harassment Or Abuse Ingame Or Out Of Game<br/>
				5. Duping And Injecting Are Not Allowed And We Have Custom Anti Hack And Logging Software<br/><br/>
				"
		]
	];
		...
		[
			"Safe Zones",
				"
					...
					All Police HQs<br/>
					Rebel Outposts<br/>
					All NPC's Except Drug Processing And Field<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["serverrules",
		[
			"Cop Interaction", 
				...
				1. Civilians can be arrested For Talking About Crimes<br/>
				...
				4. Following and or harassing cops<br/>
				5. Actively blocking cops from doing their duties<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				Scroll: Activates cop siren lights (as a cop).<br/>
				"
		]
	];